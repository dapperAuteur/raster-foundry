...
import projectScenesTpl from './pages/projects/detail/projectScenes/projectScenes.html';
// new ^
...
function projectEditStates($stateProvider) {
    $stateProvider.state('projects.edit', {
        ...
        .state('projects.edit.color.scenes', {
            url: '/scenes',
    ...
    //     url: '/order',
    //     templateUrl: projectSceneOrderTpl,
    //     controller: 'ProjectsScenesOrderController',
    //     controllerAs: '$ctrl'
    // })
    ...
    //     abstract: true
    // })
    // .state('projects.edit.masking.scenes', {
    //     url: '/scenes',
    //     templateUrl: projectSceneMaskingTpl,
    //     controller: 'ProjectsScenesMaskingController',
    //     controllerAs: '$ctrl'
    // })
    // .state('projects.edit.masking.draw', {
    //     url: '/mask',
    //     templateUrl: projectSceneDrawMaskTpl,
    //     controller: 'ProjectsScenesMaskingDrawController',
    //     controllerAs: '$ctrl'
    // })
    // .state('projects.edit.share', {
    //     url: '/share',
    //     templateUrl: projectShareTpl,
    //     controller: 'ProjectsShareController',
    //     controllerAs: '$ctrl'
    // })
    // .state('projects.edit.export', {
    //     url: '/export',
    //     templateUrl: projectExportTpl,
    //     controller: 'ProjectsShareController',
    //     controllerAs: '$ctrl'
    // });
}
